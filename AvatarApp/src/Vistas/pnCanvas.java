...
public class pnCanvas extends javax.swing.JPanel implements Observer {
    ...
    public pnCanvas(Ventana vent) {
        ...
        URL resource2 = getClass().getResource("/img/body/EmptyBody.PNG");
        try {
            image2 = ImageIO.read(resource2);
        } catch (IOException e) {
            e.printStackTrace();
        }
        URL resource3 = getClass().getResource("/img/body/EmptyBody.PNG");
        try {
    ...
    public void paint(Graphics g) {
        ...
        //OJOSm   272  140
//        graf.drawImage(image2, 33, 5, 170, 200, this);
//        //BOCA 151  65
//        graf.drawImage(image3, 33, 5, 170, 200, this);
//PIES
